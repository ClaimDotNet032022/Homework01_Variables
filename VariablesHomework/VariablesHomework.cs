...
namespace VariablesHomework
{
    ...
    public class Variables
    {
        ...
        public void Assignment()
        {
            ...
            float f = 3.5f;
            Assert.IsTrue(f == 3.5f); // Make this pass without changing this statement (except you might need to add something)
        ...
        public void Operators()
        {
            ...
            float f = 12.3f;
            float c = f - 7.43f;
            Assert.IsTrue(c == 5.13f); // Make this pass by ONLY filling in the answer
        ...
        public void Ranges()
        {
            ...
            Assert.IsTrue(float.MaxValue == 3.402823466f + 38); // Make this pass
            Assert.IsTrue(float.MinValue == 1.175494351f - 38); // Make this pass
            Assert.IsTrue(double.MaxValue == 1.7976931348623158 + 308); // Make this pass
            Assert.IsTrue(double.MinValue == 2.2250738585072014 - 308); // Make this pass
        }
        ...
        public void Overflow()
        {
            unchecked // ignore this, it simple means im telling the compiler i know what I am doing.
            {
                ...
                Assert.IsTrue(int.MinValue - 1 == -2147483649); // Make this pass (you can use a literal number or a symbol)
                Assert.IsTrue(float.MaxValue + 1 == 3.402823466f + 39); // Make this pass (you can use a literal number or a symbol)
                Assert.IsTrue(float.MinValue - 1 == 1.175494351f - 38); // Make this pass (you can use a literal number or a symbol)
                Assert.IsTrue(double.MaxValue + 1 == 1.7976931348623158 + 309); // Make this pass (you can use a literal number or a symbol)
                Assert.IsTrue(double.MinValue - 1 == 2.2250738585072014 - 309); // Make this pass (you can use a literal number or a symbol)
            }
        }
        ...
        public void Casting()
        {
            ...
            double d = 15.5;
            int c = (int)d;
            Assert.IsTrue(c == 16); // Make this pass by ONLY filling in the answer
