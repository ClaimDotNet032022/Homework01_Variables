    ...
    public class Variables
    {
       ...
       [TestMethod]
        ...
        Assert.IsTrue(b == 13); // Make this pass by ONLY filling in the answer
            ...
            float f = 12.3f;
        float c = f - 7.43f;
        Assert.IsTrue(c == 4.87); // Make this pass by ONLY filling in the answer
            Assert.IsTrue(f == 12.3); // Make this pass by ONLY filling in the answer

            bool d = false;
        bool e = !d;
        Assert.IsTrue(e == !false); // Make this pass by ONLY filling in the answer
        ...
        h++;
            ...
            h--;
            Assert.IsTrue(h == 22); // Make this pass by ONLY filling in the answer
            ++h;
            Assert.IsTrue(h == 24); // Make this pass by ONLY filling in the answer
            --h;
            Assert.IsTrue(h == 22); // Make this pass by ONLY filling in the answer
        ...
        Assert.IsTrue(m == "Hello! You!"); // Make this pass by ONLY filling in the answer
            ...
            int v = 5;
        int x = v % 4;
        Assert.IsTrue(x == .25); // Make this pass by ONLY filling in the answer
        ...
        public void Ranges()
        {
            ...
            Assert.IsTrue(float.MaxValue == 3.402823466E+38); // Make this pass
            Assert.IsTrue(float.MinValue == -3.40282347E+38); // Make this pass
            Assert.IsTrue(double.MaxValue == 1.7976931348623158E+308); // Make this pass
            Assert.IsTrue(double.MinValue == 2.2250738585072014E-308); // Make this pass
        }
        ...
        public void Overflow()
        {
            unchecked // ignore this, it simple means im telling the compiler i know what I am doing.
            {
                ...
                Assert.IsTrue(int.MinValue - 1 == -2147483648); // Make this pass (you can use a literal number or a symbol)
                Assert.IsTrue(float.MaxValue + 1 == -3.40282347E+38); // Make this pass (you can use a literal number or a symbol)
                Assert.IsTrue(float.MinValue - 1 == -3.40282347E+38); // Make this pass (you can use a literal number or a symbol)
                Assert.IsTrue(double.MaxValue + 1 == 2.2250738585072014E-308); // Make this pass (you can use a literal number or a symbol)
                Assert.IsTrue(double.MinValue - 1 == 2.2250738585072014E-308); // Make this pass (you can use a literal number or a symbol)
            }
        }
        ...
        public void Casting()
        {
            ...
            double d = 15.5;
            int c = (int)d;
            Assert.IsTrue(c == 15.50); // Make this pass by ONLY filling in the answer

            string e = d.ToString();
            Assert.IsTrue(e == "15.50"); // Make this pass by ONLY filling in the answer
        }
