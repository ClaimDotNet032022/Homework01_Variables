...
namespace VariablesHomework
{
    ...
    public class Variables
    {
        ...
        public void Operators()
        {
            ...
            float f = 12.3f;
            float c = f - 7.43f;
            Assert.IsTrue(c == 12.3f - 7.43f); // Make this pass by ONLY filling in the answer
        ...
        public void Ranges()
        {
            Assert.IsTrue(int.MaxValue == 2_147_483_647); // Make this pass
            Assert.IsTrue(int.MinValue == -2_147_483_648); // Make this pass
        ...
        public void Overflow()
        {
            ...
            {
                Assert.IsTrue(int.MaxValue + 1 == int.MinValue); // Make this pass (you can use a literal number or a symbol)
                Assert.IsTrue(int.MinValue - 1 == int.MaxValue); // Make this pass (you can use a literal number or a symbol)
                Assert.IsTrue(float.MaxValue + 1 == float.MaxValue); // Make this pass (you can use a literal number or a symbol)
                Assert.IsTrue(float.MinValue - 1 == float.MinValue); // Make this pass (you can use a literal number or a symbol)
                Assert.IsTrue(double.MaxValue + 1 == double.MaxValue); // Make this pass (you can use a literal number or a symbol)
                Assert.IsTrue(double.MinValue - 1 == double.MinValue); // Make this pass (you can use a literal number or a symbol)
            }
        }
        ...
        public void Conversion()
        {
            ...
            //d = 15.5;
            //int c = d;  // There is no implicit cast from double to int because it is a narrowing/lossy conversion
        }
